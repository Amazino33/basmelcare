<div>
    ...
    {{-- Its own component so it can refresh itself. The rest of this page is
         a picture of a chosen period and costs some thirty-five queries to
         draw; the shelf is two aggregates and changes with every sale. --}}
    <livewire:dashboard.potential-profit />
